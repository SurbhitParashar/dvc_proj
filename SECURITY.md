...
If you find a security vulnerability in dvc_proj, please report it through [GitHub's private vulnerability reporting](https://github.com/SurbhitParashar/dvc_proj/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact surbhitparashar7@gmail.com for details.
